...
// Bounce Animation
class OptimizedBounce extends StatefulWidget {
  final Widget child;
  final Duration duration;
  final Duration delay;
  final bool repeat;
  ...
  @override
  State<OptimizedBounce> createState() => _OptimizedBounceState();
}

class _OptimizedBounceState extends State<OptimizedBounce>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;
...
// Pulse Animation
class OptimizedPulse extends StatefulWidget {
  final Widget child;
  final Duration duration;
  final Duration delay;
  ...
  @override
  State<OptimizedPulse> createState() => _OptimizedPulseState();
}

class _OptimizedPulseState extends State<OptimizedPulse>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;
...
// Shake Animation
class OptimizedShake extends StatefulWidget {
  final Widget child;
  final Duration duration;
  final double offset;
  ...
  @override
  State<OptimizedShake> createState() => _OptimizedShakeState();
}

class _OptimizedShakeState extends State<OptimizedShake>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _animation;
...
class OptimizedLoadingAnimation extends StatefulWidget {
  ...
  @override
  State<OptimizedLoadingAnimation> createState() =>
...
class OptimizedDotsLoading extends StatefulWidget {
  final Color color;
  final double size;
  final Duration duration;

  const OptimizedDotsLoading({
    super.key,
    this.color = AppColors.primary,
    this.size = 12.0,
  ...
  @override
  State<OptimizedDotsLoading> createState() => _OptimizedDotsLoadingState();
}

class _OptimizedDotsLoadingState extends State<OptimizedDotsLoading>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
...
class OptimizedSuccessCheck extends StatefulWidget {
  final double size;
  final Duration duration;
  final VoidCallback? onComplete;

  const OptimizedSuccessCheck({
    super.key,
    this.size = 60,
  ...
  @override
  State<OptimizedSuccessCheck> createState() => _OptimizedSuccessCheckState();
}

class _OptimizedSuccessCheckState extends State<OptimizedSuccessCheck>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _scaleAnimation;
